...
def parse_args():
    ...
    parse.add_argument('--height2', type=int, help='height of Cylinder')
    parse.add_argument('--height3', action = 'store_true', default='false',help='height of Cylinder')
    parse.add_argument('--height4', type=str, help='height of Cylinder')
